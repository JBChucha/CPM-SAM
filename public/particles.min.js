...
var pJS = function (e, a) {
  ...
  (a && Object.deepExtend(i, a),
    ...
    (i.fn.particle = function (e, a, t) {
      ...
      ((this.opacity =
        (i.particles.opacity.random ? Math.random() : 1) * i.particles.opacity.value),
      ...
      (i.particles.move.straight
        ? ((this.vx = n.x),
          ...
          i.particles.move.random &&
            ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random())))
    ...
    (i.fn.particlesUpdate = function () {
      for (var e = 0; e < i.particles.array.length; e++) {
        ...
        if (
          (i.particles.opacity.anim.enable &&
            (1 == a.opacity_status
              ? (a.opacity >= i.particles.opacity.value && (a.opacity_status = !1),
                (a.opacity += a.vo))
              : (a.opacity <= i.particles.opacity.anim.opacity_min && (a.opacity_status = !0),
                (a.opacity -= a.vo)),
            a.opacity < 0 && (a.opacity = 0)),
          i.particles.size.anim.enable &&
            (1 == a.size_status
              ? (a.radius >= i.particles.size.value && (a.size_status = !1), (a.radius += a.vs))
              : (a.radius <= i.particles.size.anim.size_min && (a.size_status = !0),
                (a.radius -= a.vs)),
    ...
    (i.fn.interact.linkParticles = function (e, a) {
      ...
      if (n <= i.particles.line_linked.distance) {
        var r =
          ...
          n / (1 / i.particles.line_linked.opacity) / i.particles.line_linked.distance;
        if (r > 0) {
          ...
          if (c >= 0 && 'mousemove' == i.interactivity.status) {
            ...
            if (i.interactivity.modes.bubble.opacity != i.particles.opacity.value)
              if (i.interactivity.modes.bubble.opacity > i.particles.opacity.value) {
                ...
                var v =
                  e.opacity -
                  (i.particles.opacity.value - i.interactivity.modes.bubble.opacity) * c;
                v < e.opacity &&
                  v >= i.interactivity.modes.bubble.opacity &&
                  (e.opacity_bubble = v);
              }
