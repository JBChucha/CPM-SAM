 ...
 * showing the selected day in Thai Buddhist Era.
 *
 * Same component the purchase-order screens use; kept here as its own copy so
 * the new screens depend on `@/lib/format-date-be` rather than reaching into
